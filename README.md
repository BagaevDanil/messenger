...
*	Статус сообщения (отправлено/просмотрено)
...
* Просмотр сообщения - изменяет данные о сообщение в БД и рассылает новую информацию клиентам.
...
Экран с мессенджером позволяет получать и отправлять сообщения. Сообщения могут содержать текст или файлы, а также указан создатель сообщения, время создания и специальная пометка, если соообщение прочитали. Прикрепленные к сообщению файлы можно скачать на компьютер. Пользователь обладает возможностью редактировать отправленные сообщения.
...
*	Messenges - хранит историю сообщений (id, логин создателя, текст сообщения, время создания, тип сообщения, id прикрепленного файла, пометка о редактировании, пометка о просмотре)
